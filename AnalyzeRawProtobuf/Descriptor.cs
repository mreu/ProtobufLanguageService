...
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Descriptor.cs" company="Michael Reukauff">
//   Copyright © 2015 Michael Reukauff
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
#endregion

namespace AnalyzeRawProtobuf
{
    ...
    public class FileDescriptorSet
    {
        ...
        {
            File = new List<FileDescriptor>();
        }

        /// <summary>
        /// Gets the file descriptors.
        /// </summary>
        public List<FileDescriptor> File { get; private set; }
    }
